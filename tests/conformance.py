...
CASOS = [
    ...
    ("retorno de objeto (v3 permite)", "ok",
     'class P{ int x; P constructor(){ this.x=0; } } function P cria(){ return new P(); }'),
    ("parametro vetor com tamanho", "ok",
     'function int primeiro(int[5] a){ return a[0]; }'),
    ("parametro objeto", "ok",
     'class P{ int x; P constructor(int x){ this.x=x; } } function int lerX(P p){ return p.x; }'),
    ...
    ("return fora de funcao", "sem",
     'return 1;'),
    ("retorno de vetor proibido (v3)", "sem",
     'function int[3] cria(){ let int[3] v; return v; }'),
